...
<ul class="breadcrumbs">
	...
	<li><?= $mb->_translateReturn("menu", "month-register") ?></li>
</ul>
	...
	<div class="simple-form">
		...
		<div class="form-content">
			<div class="content-header">
				...
				<?= $mb->_translateReturn("forms", "legend-results") ?> voor maand <?= isset($_POST['month']) ? intval($_POST['month']) : intval(date("m")) ?>
			</div>
			...
			<table class="form-table">
				...
				<tbody>
					<?php
					$data = $mb->_runFunction("reports", "closeRegister", array($_SESSION['merchantID'], "month_" . (isset($_POST['month']) ? (intval($_POST['month']) . "_" . intval($_POST['year'])) : (date("m") . "_" . date("Y")))));
