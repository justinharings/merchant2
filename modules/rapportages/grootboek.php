...
$data = $mb->_runFunction("reports", "viewPaymentBook", array($_SESSION['merchantID'], (isset($_POST['month']) ? $_POST['month'] : date("m")), (isset($_POST['year']) ? $_POST['year'] : date("Y"))));
?>

<ul class="breadcrumbs">
	<li>Merchant</li>
	<li><?= $mb->_translateReturn("menu", "reports") ?></li>
	<li><?= $mb->_translateReturn("menu", "payment-book") ?></li>
</ul>
	...
	<div class="simple-form">
		...
		<div class="form-content">
			...
			<table class="form-table">
				<thead>
					<tr>
						<td><?= $mb->_translateReturn("forms", "form-reports-table-customer") ?></td>
						...
						<td><?= $mb->_translateReturn("forms", "form-reports-table-date") ?></td>
					</tr>
				</thead>
						...
						<tr>
							<td>
								...
								if($value['customer'] != "")
								{
									...
									<small>
										<a href="/<?= $_GET['language_pack'] ?>/modules/verkoop/afgerond/form-order/<?= $value['orderID'] ?>/">
											<?= $value['orderID'] ?>
										</a>
									</small>
									-
