...
{
	$data = $mb->_runFunction("groups", "load", array($_GET['dataID']));
}
?>
...
<form method="post" id="form" action="/library/php/posts/instellingen/groepen.php">
	<input type="hidden" name="groupID" id="groupID" value="<?= isset($_GET['dataID']) ? $_GET['dataID'] : 0 ?>" />
	...
	<div class="simple-form">
		...
		<div class="form-content">
			...
			<input type="text" name="name" id="name" value="<?= isset($_GET['dataID']) ? $data['name'] : "" ?>" class="width-300" holder="<?= $mb->_translateReturn("forms", "form-group-name") ?>" holder-eg="<?= $mb->_translateReturn("forms", "form-group-name-eg") ?>" validation-required="true" validation-type="text" />
		</div>
	</div>
</form>