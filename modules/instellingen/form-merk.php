...
{
	$data = $mb->_runFunction("brands", "load", array($_GET['dataID']));
}
?>
...
<form method="post" id="form" action="/library/php/posts/instellingen/merken.php">
	<input type="hidden" name="brandID" id="brandID" value="<?= isset($_GET['dataID']) ? $_GET['dataID'] : 0 ?>" />
	...
	<div class="simple-form">
		...
		<div class="form-content">
			...
			<input type="text" name="name" id="name" value="<?= isset($_GET['dataID']) ? $data['name'] : "" ?>" class="width-300" holder="<?= $mb->_translateReturn("forms", "form-supplier-name") ?>" holder-eg="<?= $mb->_translateReturn("forms", "form-supplier-name-eg") ?>" validation-required="true" validation-type="text" />
		</div>
	</div>
</form>