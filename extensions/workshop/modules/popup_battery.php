...
<html lang="nl">
	...
	<body class="popup">
		<form method="post" action="/extensions/workshop/library/php/posts/battery.php">
			<input type="hidden" name="workorderID" id="workorderID" value="<?= isset($_GET['workorderID']) ? $_GET['workorderID'] : 0 ?>" />
			
			<input type="text" name="barcode" id="barcode" value="" holder="Barcode accu" class="width-100-percent margin" />
			<input type="text" name="ampere" id="ampere" value="" holder="Amperes" holder-eg="Nieuw bij aanschaf." class="width-100-percent double-margin" />
