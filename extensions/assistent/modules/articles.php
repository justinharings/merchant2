...
<form method="post" action="/extensions/assistent/library/php/posts/articles.php">
		...
		<tbody>
			...
			if(count($data))
			{
				...
				foreach($data AS $key => $value)
				{
					...
					if	(
							(
								strtotime($value['date_update_core']) > strtotime(date("Y-m-d H:i:s", (time()-5184000)))
							) 
