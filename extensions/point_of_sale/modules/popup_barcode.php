...
<html lang="nl">
	...
	<body class="popup">
		<form id="barcode-form" method="post" action="/extensions/point_of_sale/library/php/posts/new_barcode.php">
			<img src="/library/media/barcode.png" />
			<input type="text" name="barcode" id="barcode" value="" class="width-100-percent text-center" />
			<input type="hidden" name="key" id="key" value="<?= intval($_GET['key']) ?>" />
		</form>
