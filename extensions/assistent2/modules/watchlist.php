...
<div class="container blush">
	<div class="inner-container">
		...
		<div class="menu">
			<ul>
				<li browse="/extensions/assistent2/library/php/watchlist_remove.php?productID=<?= intval($_GET['productID']) ?>">
					<span class="fa fa-thumbs-up"></span>
					Negeren en doorgaan
				</li>
				
				<li browse="/extensions/assistent2/library/php/watchlist_to_alert.php?productID=<?= intval($_GET['productID']) ?>&orderProductID=<?= intval($_GET['orderProductID']) ?>">
				...
				<li browse="/extensions/assistent2/">
					...
					Op de watchlist houden
				</li>
			</ul>
		</div>
		
		<div class="content">
			<h1>Artikel op de watchlist</h1>
