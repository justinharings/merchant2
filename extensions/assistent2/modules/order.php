...
?>
<div class="container alice-blue">
	<div class="inner-container">
		<div class="title fa fa-shopping-bag"></div>
		...
		<div class="content">
			<h1>
				Order #<?= $order['order_reference'] ?> inplannen
				
				<?php
				if(isset($_GET['noshow']))
				{
					print "<br/><small>Deze klant is niet komen opdagen.</small>";
				}
				?>
			</h1>
